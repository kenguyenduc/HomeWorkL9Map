    ...
    return (
      <View style={styles.container}>
        <MapView style={styles.map} region={this.state.region}
          ...
          <MapView.Circle center={this.state.markers[0].latlng}
           radius="100" strokeWidth={5} fillColor="#0f0a"/>
          <MapView.Polyline coordinates={coordinates}
            strokeWidth={5} strokeColor="#00fa"/>
          <MapView.Polygon coordinates={coordinates}
            strokeWidth={5} strokeColor="#00fa" fillColor="#0aaa"/>
